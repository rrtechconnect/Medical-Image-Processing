...
subplot(5,4,2);
imshow(blurredImage); 
title(sprintf( 'BOX Blurr noise:PSNR %0.4f',peaksnr0 ));
...
subplot(2,3,2);
imshow (blurredImage);
title(sprintf( 'Boxblur-average noise:PSNR %0.4f',peaksnr0 ));
 subplot(2,3,3);
 imshow(g10);
 title(sprintf( 'K1 Deblurred image with PSNR %0.4f',peaksnr1 ))
 subplot(2,3,4);
